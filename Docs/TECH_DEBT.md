...
- **Description**: The production bundle size has increased to ~986 KB after adding form controls, which is large for a standard static landing and form layout.
